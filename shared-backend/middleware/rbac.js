...
const PERMISSIONS = {
  ...
  READ_PROCUREMENT: 'read_procurement',
  WRITE_PROCUREMENT: 'write_procurement',
...
const ROLE_PERMISSIONS = {
  ...
  [ROLES.ADMIN]: [
    ...
    PERMISSIONS.READ_PROCUREMENT,
    PERMISSIONS.WRITE_PROCUREMENT,
    PERMISSIONS.DELETE_PROCUREMENT,
