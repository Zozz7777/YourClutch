...
export const NAVIGATION_ITEMS = [
  ...
  },
  {
    ...
    href: "/procurement",
    icon: "ShoppingCart",
    permissions: [PERMISSIONS.VIEW_PROCUREMENT],
  },
] as const;
